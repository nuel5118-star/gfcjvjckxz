...
export const api = {
  ...
  getIntentTracks: () => req('GET', '/intent-tracks'),
  getIntentTrack: (id) => req('GET', `/intent-tracks/${id}`),
  createIntentTrack: (data) => req('POST', '/intent-tracks', data),
  updateIntentTrack: (id, data) => req('PUT', `/intent-tracks/${id}`, data),
